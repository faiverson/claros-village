        ...
        <div className="flex flex-col gap-4 px-4 py-4 lg:flex-row lg:gap-8">
          <div className="flex flex-col gap-2 lg:w-1/3 justify-center">
            <div className="flex items-center gap-2">
              ...
              Claros Village fue desarrollado por <a href="https://www.grupoedisur.com.ar/quienes-somos-grupo-edisur" target="_blank" rel="noopener noreferrer" className="hover:underline">Grupo Edisur</a>
            </span>
            </div>
          </div>
            ...
            <div className="space-y-1">
              ...
              <ul className="space-y-1 text-xs">
                <li className="flex items-center gap-1">
                  ...
                  <a href={`mailto:directorio@clarosvillage.org.ar`}
                  target="_blank"
                    rel="noopener noreferrer">directorio@clarosvillage.org.ar</a>
                </li>
                <li className="flex items-center gap-1">
                  <Mail className="h-4 w-4" />
                  <a href={`mailto:denuncias@clarosvillage.org.ar`}
                  target="_blank"
                    rel="noopener noreferrer">denuncias@clarosvillage.org.ar</a>
                </li>
                <li className="flex items-center gap-1">
                  <Mail className="h-4 w-4" />
                  <a href={`mailto:intendencia@clarosvillage.org.ar`}
                  target="_blank"
                    rel="noopener noreferrer">intendencia@clarosvillage.org.ar</a>
                </li>
              </ul>
            </div>
          </div>
