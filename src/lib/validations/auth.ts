...
export const registerSchema = z
  .object({
    email: z.string().min(1, { message: 'El correo es requerido' }).email({ message: 'Correo electrónico inválido' }),
    password: z
      .string()
    ...
    unidad: z.string().min(1, { message: 'Debe seleccionar una unidad' }),
    phone: z
      .string()
