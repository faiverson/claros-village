  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Verificación de cuenta</h2>
        </div>
        <div className="mt-8">
          {status === 'loading' && (
          ...
          {status === 'error' && (
            <div className="flex flex-col items-center space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <p className="text-xl text-destructive-600">{message}</p>
              </div>
              <div className="mt-4">
                <Link href="/auth/signin" className="flex items-center space-x-2 text-primary-600 hover:text-primary-500">
