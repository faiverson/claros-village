  ...
  const getErrorMessage = (error: string) => {
    switch (error) {
      ...
      case 'Tu cuenta no está activa. Por favor verifica tu correo electrónico.':
        return (
          <span>
            Tu cuenta no está activa. Por favor revisa tu correo electrónico y sigue las instrucciones
            para verificar tu cuenta. <Link href="/auth/register" className="text-primary-500 hover:text-primary-600 underline">
      ...
      case 'Por favor verifica tu correo electrónico antes de iniciar sesión.':
        return (
          <span>
            ...
            Revisa tu bandeja de entrada y sigue las instrucciones enviadas.
          </span>
        );
      default:
