...
export default function UserProfile() {
    ...
    return (
        <Dropdown>
            <DropdownTrigger>
                {avatarUrl ? (
                    <Avatar isBordered as="button" className="transition-transform hover:cursor-pointer" src={avatarUrl} />
                ) : (
            ...
            <DropdownMenu aria-label="Link Actions">
                {userMenu
                    ...
                    .map((menuItem) => {
                        const props = menuItem.onClick ? { onClick: menuItem.onClick } : { href: menuItem.href }
                        return (
